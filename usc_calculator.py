...
arty_calculator = UltraSuperCalculator('Arty')
# Adds 5 and 10 to number registers
arty_calculator.binary_reader("00000100000000000000000101000000")
arty_calculator.binary_reader("00000100000000000000001010000000")

# Adds/Subtracts/Multiplies/Divides 5 and 10 from registers
arty_calculator.binary_reader("00000000001000100000000000100000")
arty_calculator.binary_reader("00000000001000100000000000100010")
arty_calculator.binary_reader("00000000001000100000000000011000")
#arty_calculator.binary_reader("00000000001000100000000000011010")

# Gets the last three calculations
arty_calculator.binary_reader("10000100000000000000000000000000")
arty_calculator.binary_reader("10000100000000000000000000000000")
arty_calculator.binary_reader("10000100000000000000000000000000")